...
themehouse.topics.topicChooser = {
    ...
    unsetTopic: function() {
        ...
        $('.thTopic__createThreadBar__topics').each(function () {
            $(this).find('.thTopic').slice(1).remove();
            $createThreadBarTopic = $(this).find('.thTopic').first();
        ...
        if ($('.thTopic__createThreadBar__topics .thTopic[data-xf-click=th_topicChooser]').first().trigger('click')) {
            XF.hideOverlays();
        }
    },
    ...
    checkCreateThreadBarOverflow: function() {
        ...
        $firstCreateThreadBarTopics.each(function() {
            ...
            if ((this.offsetHeight < this.scrollHeight) || (this.offsetWidth < this.scrollWidth)) {
                $additionalTopics = $(this).find('.thTopic').slice(1);
